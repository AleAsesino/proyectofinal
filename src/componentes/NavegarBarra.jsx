    ...
    <div className='container-fluid p-5 sticky-top d-flex align-items-center justify-content-center mt-5'>
      <div className='mt-5'>
            ...
            <div class="d-grid gap-2 p-2 mt-5">
                ...
                <button className="btn mt-4 btn-outline-success btn-lg" type="button"><Link className='text-decoration-none colortextE' to='/menu'><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" className="bi bi-house-door me-1 " viewBox="0 0 16 16">
